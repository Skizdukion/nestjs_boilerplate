...
export interface UniswapProtocolPairInterface extends utils.Interface {
  contractName: "UniswapProtocolPair";
  functions: {
...
export interface UniswapProtocolPair extends BaseContract {
  contractName: "UniswapProtocolPair";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapProtocolPairInterface;
  ...
  callStatic: {
    ...
    setDevFee(_devFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
