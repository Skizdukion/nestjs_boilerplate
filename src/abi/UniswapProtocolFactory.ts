...
export interface UniswapProtocolFactoryInterface extends utils.Interface {
  contractName: "UniswapProtocolFactory";
  functions: {
...
export interface UniswapProtocolFactory extends BaseContract {
  contractName: "UniswapProtocolFactory";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapProtocolFactoryInterface;
