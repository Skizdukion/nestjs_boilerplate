...
export class CreateNameTable1671419911405 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "network" ("id" SERIAL NOT NULL, "chainId" integer NOT NULL, "name" character varying NOT NULL, "rpcUrl" text array NOT NULL DEFAULT '{}', CONSTRAINT "UQ_9f79766aae97061ce6d051470ad" UNIQUE ("chainId"), CONSTRAINT "PK_8f8264c2d37cbbd8282ee9a3c97" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "factory" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "address" character varying NOT NULL, "totalPoolCounts" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "networkId" integer, CONSTRAINT "UQ_ADDRESS_F" UNIQUE ("address", "networkId"), CONSTRAINT "PK_1372e5a7d114a3fa80736ba66bb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "token" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "name" character varying NOT NULL, "countExists" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "networkId" integer, CONSTRAINT "UQ_ADDRESS_T" UNIQUE ("address", "networkId"), CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pool" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "reserve1" bigint NOT NULL, "reserve2" bigint NOT NULL, "swapFee" bigint NOT NULL, "indexCount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "token1Id" integer, "token2Id" integer, "factoryId" integer, CONSTRAINT "UQ_0764827295d4ed49e259aa398fc" UNIQUE ("address"), CONSTRAINT "UQ_ADDRESS_P" UNIQUE ("address", "factoryId"), CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`);
